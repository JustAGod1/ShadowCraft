...
import com.justagod.shadowcraft.Blocks.Grower.GrowerTile.GrowRecipe;
import com.justagod.shadowcraft.ShadowCraft;
import net.minecraft.init.Items;

import static com.justagod.shadowcraft.Blocks.Grower.GrowerTile.GrowRecipeRegister.registerRecipe;
...
public final class GrowerRecipes {
    ...
    public static final GrowRecipe ENDER_EYE_TO_SHADOW_CORE = new GrowRecipe(Items.ender_eye, ShadowCraft.shadow_core, 2000);
